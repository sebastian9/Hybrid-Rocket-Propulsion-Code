...
%%  Plot results 
figure(1)
subplot(2,3,1), plot(t(:),state(:,3),'k'), ... 
    ...
    set(gca, ...
        ...
        'LineWidth'   , 1         , ...
        'FontName'   , 'Helvetica');
subplot(2,3,2), plot(t(:),state(:,1)*env.Motor.MW_ox,'k-o','MarkerIndices',1:ceil(length(t)/20):length(t)),
    ...
    set(gca, ...
        ...
        'LineWidth'   , 1         , ...
        'FontName'   , 'Helvetica');
subplot(2,3,3), plot(t(:),state(:,4),'k'), ... 
    ...
    set(gca, ...
        ...
        'LineWidth'   , 1         , ...
        'FontName'   , 'Helvetica');
subplot(2,3,4), plot(t(:),state(:,5)/1e5,'k'),...
    ...
    legend('Chamber Pressure', 'Oxidizer Tank Pressure');
     set(gca, ...
        ...
        'LineWidth'   , 1         , ...
        'FontName'   , 'Helvetica');
subplot(2,3,5), plot(t(:),state(:,7),'k'),grid, ... 
    ...
    ylabel('Density [kg/m^3]');
     set(gca, ...
        ...
        'LineWidth'   , 1         , ...
        'FontName'   , 'Helvetica');
subplot(2,3,6), plot(t(:),state(:,8),'k-o','MarkerIndices',1:ceil(length(t)/20):length(t)), ...
